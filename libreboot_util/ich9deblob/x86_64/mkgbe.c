...
struct GBEREGIONRECORD_4K generatedGbeStruct4k()
{
    ...
    gbeStruct4k.macAddress[1] = 0x1c;
    gbeStruct4k.macAddress[2] = 0x25;
    gbeStruct4k.macAddress[3] = 0x9a;
    gbeStruct4k.macAddress[4] = 0xf4;
    gbeStruct4k.macAddress[5] = 0x7c;
